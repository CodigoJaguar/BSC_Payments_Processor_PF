...
import { IBscScanResponse } from '../interfaces/bscscan-reply-interfaces';
...
export class BscScanApi {
    ...
    async listTransactions(initialBlock=0){
        ...
        const bscScanResponse = response.data as IBscScanResponse<IBscTransactions[]>;
    ...
    private loadSettings(){
        ...
        if (!key) throw new Error('BSCSCAN key is undefined')
        this.key = key;
