...
exports.migration1677715725442 = void 0;
class migration1677715725442 {
    constructor() {
        this.name = 'migration1677715725442';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            CREATE TABLE "temporary_transaction" (
                ...
                "currencyId" integer,
                CONSTRAINT "FK_a6eb26abbedbeaeb81ff45c5490" FOREIGN KEY ("currencyId") REFERENCES "currency" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
                CONSTRAINT "FK_900eb6b5efaecf57343e4c0e79d" FOREIGN KEY ("walletId") REFERENCES "wallet" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
            )
        `);
        await queryRunner.query(`
            INSERT INTO "temporary_transaction"(
...
exports.migration1677715725442 = migration1677715725442;
//# sourceMappingURL=1677715725442-migration.js.map